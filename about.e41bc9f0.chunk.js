...
var _config = __webpack_require__(600);
...
var _config = __webpack_require__(604);
...
var action = function action(option) {
    ...
    this.handleAboutClick = function () {
        _this.component.props.onRedirect({ appName: 'xr-template-root-about', appParams: {} });
    };

    this.handleHelloClick = function () {
        _this.component.props.onRedirect({ appName: 'xr-template-root-helloWorld', appParams: {} });
    };
...
//# sourceMappingURL=about.e41bc9f0.chunk.js.map