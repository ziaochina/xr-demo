...
var _config = __webpack_require__(606);
...
var action = function action(option) {
    ...
    this.onRedirect = function (_ref2) {
        ...
        _this.injections.reduce('redirect', appName, appProps);
    };
...
var reducer = function reducer(option) {
    ...
    this.init = function (state, option) {
        var cfg = _config2.default.getCurrent();
        var data = {
            data: {
    ...
    this.redirect = function (state, appName, appProps) {
        state = _this.metaReducer.sf(state, 'data.currentAppName', appName);
        state = _this.metaReducer.sf(state, 'data.currentAppProps', appProps);
        return state;
    };
...
//# sourceMappingURL=xr-template-root.e41bc9f0.chunk.js.map